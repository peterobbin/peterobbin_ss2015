...
float scope(float x, float y, float x2, float y2, float scale, float blurriness){
    ...
    pct /= min(1.0 - distance(st,vec2(x2, y2)),1.0 - distance(st,vec2(x2, y2))) * 2.0 * scale;
...
void main(){
    ...
    float sinC2 = sin(u_time * PI + 2.0/3.0) * 0.2 + 0.2;
    float cosC2 = cos(u_time * PI + 2.0/3.0) * 0.2 + 0.2;
    float sinC3 = sin(u_time * PI + 2.0/3.0 * 2.0) * 0.2 + 0.2;
    float cosC3 = cos(u_time * PI + 2.0/3.0 * 2.0) * 0.2 + 0.2;
